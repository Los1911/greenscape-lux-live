...
export default function UnifiedLogin() {
  ...
  const userType =
    (searchParams.get('type') as 'client' | 'landscaper' | 'admin') ||
    getUserTypeFromPath(location.pathname);

  const tab =
    (searchParams.get('tab') as 'login' | 'signup') ||
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(16,185,129,0.1),_transparent_50%)]" />

...
import { Crown, Calendar, CreditCard, Check, Star } from 'lucide-react';
...
const PLANS = [
  {
    ...
    amount: 999,
    interval: 'month',
    features: ['Up to 3 requests/month', 'Email support', 'Mobile access']
  },
  {
    id: 'premium_monthly', 
    name: 'Premium',
    ...
    interval: 'month',
    popular: true,
    features: ['Unlimited requests', 'Priority support', 'Advanced scheduling']
  }
];
        ...
        {subscription ? (
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="font-semibold text-lg text-white">{subscription.plan_name}</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {PLANS.map((plan) => (
                <Card key={plan.id} className={`bg-slate-800 border-slate-700 ${plan.popular ? 'ring-2 ring-blue-500' : ''}`}>
                  {plan.popular && (

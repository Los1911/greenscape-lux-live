...
const ENVIRONMENT_CONFIGS: Record<Environment, EnvironmentConfig> = {
  development: {
    ...
    errorMessages: {
      ...
      VITE_SUPABASE_PUBLISHABLE_KEY: 'Must be a valid Supabase publishable key (100+ chars)',
  ...
  staging: {
    ...
    errorMessages: {
      ...
      VITE_SUPABASE_PUBLISHABLE_KEY: 'Must be a valid Supabase publishable key for staging',
  ...
  production: {
    ...
    errorMessages: {
      ...
      VITE_SUPABASE_PUBLISHABLE_KEY: 'Must be a valid production Supabase publishable key',

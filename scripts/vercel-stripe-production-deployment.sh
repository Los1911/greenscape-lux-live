...
echo ""
echo "Step 2: Adding VITE_STRIPE_PUBLISHABLE_KEY..."
echo "$STRIPE_KEY" | vercel env add VITE_STRIPE_PUBLISHABLE_KEY production --token=$VERCEL_TOKEN
...
echo "3. Look for: VITE_STRIPE_PUBLISHABLE_KEY: pk_live_51S1Ht0K6kWkUsx..."
echo ""
